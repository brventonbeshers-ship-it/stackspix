...
export default function ConnectWallet() {
  ...
  return (
    <button
      onClick={connect}
      className="px-4 py-2 text-sm font-semibold rounded-lg bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-400 hover:to-indigo-500 text-white transition-all shadow-lg shadow-purple-900/30"
    >
      Link Wallet
    </button>
  )
