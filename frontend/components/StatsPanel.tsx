    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2">
        <div className="bg-white/5 rounded-lg p-3 border border-white/10">
          ...
          <div className="text-xs text-gray-500 mt-0.5">All pixels placed</div>
        </div>
        ...
        <div className="bg-white/5 rounded-lg p-3 border border-white/10">
          ...
          <div className="text-xs text-gray-500 mt-0.5">Total cells (50x50)</div>
        </div>
      </div>

      {hoveredPixel && (
        <div className="bg-white/5 rounded-lg p-3 border border-white/10 space-y-1.5">
